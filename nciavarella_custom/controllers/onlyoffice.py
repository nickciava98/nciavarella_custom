...
from odoo.addons.onlyoffice_odoo.utils import config_utils, jwt_utils, file_utils
from odoo.addons.onlyoffice_odoo.controllers.controllers import Onlyoffice_Connector, _mobile_regex
    ...
    def prepare_editor_values(self, attachment, access_token, can_write):
        ...
        root_config = {
            ...
            "editorConfig": {
                ...
                "user": {"id": str(request.env.user.id), "name": request.env.user.login},
                "customization": {}
            }
        }
